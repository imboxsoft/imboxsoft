        ...
        <div>
            <div className="bg-main-opacity-black-75">
                    ...
                    <div className="relative max-w-screen-2xl mx-auto px-4 xs:px-10 py-20">
                        <div className="md:w-2/3">
                            ...
                            <h1 className="text-3xl font-bold mb-4">
                                Find out more about who we are and how we
                                started
                            </h1>
                ...
                <section className="observe-navbar-intersect w-full bg-main-background-lighter">
                    <div className="max-w-screen-2xl mx-auto px-4 xs:px-10 pt-32 pb-20">
                        <div className="flex flex-row gap-32">
                            <div className="flex-1">
                                ...
                                <div>
                                    <div className="mb-8">
                                        <p className="mb-4">
                                            The company’s two founders used to
                                            work independently as Full Stack
                                            Software Developers at reputable IT
                                            companies which gave start to the
                                            initiative of starting their own
                                            business in the software industry.
                                        </p>
                                        <p className="mb-4">
                                            Thus, in 2022, Imboxsoft was founded
                                            gaining a considerable start-up fund
                                            of €40.000 that propelled the
                                            company into securing considerable
                                            long-term relations and projects in
                                            the very first year of activity.
                                        </p>
                                    </div>
                                    <div className="mb-6">
                                        ...
                                        <p>
                                            ...
                                            technology for growth. Our clients
                                            see us as a long-term strategic
                                            partner and trusted adviser for
                                            product design, development, DevOps,
                                            and more.
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p>
                                            Do good and the good will come to
                                            you. We treat each software project
                                            as our own because our client’s
                                            success fuels ours many times over.
                                        </p>
                                    </div>
                                </div>
                            </div>
