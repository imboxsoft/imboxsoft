        ...
        <div className="bg-main-background-lighter-lighter">
            ...
            <div className="overflow-x-hidden">
                <section className="observe-navbar-intersect w-full bg-main-background-lighter">
                    <div className="xl:py-24 text-center md:text-left">
                        <div className="max-w-screen-xl xl:rounded-3xl mx-auto px-6 sm:px-20 pt-32 md:py-32 bg-main-background">
                            <div className="flex flex-col md:flex-row gap-10 md:gap-6 items-center">
                ...
                <section className="observe-navbar-intersect w-full bg-main-background-lighter">
                    <div className="lg:pb-32">
                        <div className="max-w-screen-xl xl:rounded-3xl mx-auto bg-main-background pt-10 md:pt-0 pb-20 md:pb-0">
                            <div className="flex flex-col gap-20 md:gap-10 lg:gap-40 md:[&>*:nth-child(even)]:flex-row-reverse">
                                <div className="relative flex flex-col md:flex-row gap-10">
                                    <div className="flex-1 px-6 sm:px-16 pt-24 pb-6 md:pb-16 flex flex-col items-center md:items-start text-center md:text-left">
                                ...
                                <div className="relative flex flex-col md:flex-row gap-10">
                                    <div className="flex-1 p-6 sm:p-16 flex flex-col items-center md:items-start text-center md:text-left">
                                        <h2 className="text-3xl font-semibold mb-6">
                                            Creating one platform to manage 6
                                            sites led to a 400% revenue growth
                                        </h2>
                                ...
                                <div className="relative flex flex-col md:flex-row gap-10">
                                    <div className="flex-1 px-6 sm:px-16 pt-6 md:pt-16 pb-6 md:pb-24 flex flex-col items-center md:items-start text-center md:text-left">
                                        <h2 className="text-3xl font-semibold mb-6">
                                            Creating one platform to manage 6
                                            sites led to a 400% revenue growth
                                        </h2>
                    ...
                    <div className="max-w-screen-xl mx-auto px-4 xs:px-10 pt-24 pb-24">
