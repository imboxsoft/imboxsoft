            ...
            <div className="overflow-x-hidden">
                <section className="observe-navbar-intersect w-full bg-gray-800">
                    <div className="xl:py-24 text-center md:text-left">
                        <div className="max-w-screen-xl xl:rounded-3xl mx-auto px-6 sm:px-20 pt-32 md:py-32 bg-gray-900">
                ...
                <section className="observe-navbar-intersect w-full bg-gray-800">
                    <div className="lg:pb-32">
                        <div className="max-w-screen-xl xl:rounded-3xl mx-auto bg-gray-900 pt-10 md:pt-0 pb-20 md:pb-0">
